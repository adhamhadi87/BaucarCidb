...
def build_email_html(owner_name, owner_id, rows):
    ...
    <body style="font-family:Arial,sans-serif;color:#222;">
        ...
        <p>
            Mohon semakan dan tindakan kemaskini dibuat dalam i-Filing BKA.
        </p>
        ...
        <p>
            ...
            <a href="https://i-filing-baucar-cidb.streamlit.app/">
                https://i-filing-baucar-cidb.streamlit.app/
            </a>
        </p>

        <p>
            <b>Aplikasi i-Filing BKA</b><br>
            <a href="https://www.appsheet.com/newshortcut/e377aa36-1623-4777">
                https://www.appsheet.com/newshortcut/e377aa36-1623-4777
            </a>
        </p>
